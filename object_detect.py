...
class Inference:
    ...
    def infer(
        ...
        web_cam = source.isnumeric() or source.endswith(".txt") or (is_url and not is_file)
        ...
        for path, im, im0s, vid_cap, s in dataset:
            ...
            with dt[1]:
                visualize = increment_path(save_dir, exist_ok=exist_ok, mkdir=True) if visualize else False
